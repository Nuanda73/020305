...
/*
g++ -w -Wall -std=c++11 GUI/Graph.cpp GUI/Window.cpp GUI/GUI.cpp GUI/Simple_Window.cpp chapter15.cpp `fltk-config --ldflags --use-images` -o ch15
*/
...
int main(){
    ...
    Function f6(sloping_sin,r_min,r_max,orig,num_points,x_scale,y_scale);
