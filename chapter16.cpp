// írjak +1 színt és vonalstílust a programba, át kellett picit helyezni a gombokat, hogy ne fedjék egymást

/*
g++ -w -Wall -std=c++11 GUI/Graph.cpp GUI/Window.cpp GUI/GUI.cpp GUI/Simple_window.cpp chapter16.cpp `fltk-config --ldflags --use-images` -o ch16
*/
...
struct Lines_window : Graph_lib::Window{
    ...
    private:
        ...
        void green_pressed() { change(Color::green); hide_menu(); }     //itt
        ...
        static void cb_green(Address, Address);     //itt
...
Lines_window::Lines_window(Point xy, int w, int h, const string& title)
	...
	style_menu{Point{x_max()-70,175},70,20,Menu::vertical,"style"},     //itt
	menu2_button{Point{x_max()-80,175}, 80, 20, "style menu",       //itt
...
color_menu.attach(new Button{Point{0,0},0,0,"green", cb_green}); //itt
...
void Lines_window::cb_green(Address, Address pw) {      //itt
