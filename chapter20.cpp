//irni egy olyan copyt, ami csak a 10 el osztható elemeket másolja át, egy predikátum függvény használatával
...
//ezzel növeljük az adott tömböt, listát vagy vektort, megadott értékkel
template<typename C>
void inc(C& c, int n){
    for(auto& i : c){
        i+=n;
...
int main(){
    ...
    print(ai);//Auto(const Auto&) = delete;
    inc(vi,3);
    inc(li,5);
	...
	vit2 = find(vi2.begin(), vi2.end(), 27);
